...
export const nhsApps = [
    ...
    },
    {
        ...
        name: 'Leavers Voluntary Redundancy Programme',
        category: 'Workforce',
        provider: 'Microsoft',
        providerBadge: 'bg-blue-100 text-blue-700',
        description: 'Intelligent workforce transition platform that streamlines voluntary redundancy planning, eligibility assessment, and severance modelling across NHS trusts.',
        features: [
        ...
        rating: '4.8',
        status: 'Available',
        externalUrl: 'https://victorious-pond-05eaeb010.6.azurestaticapps.net/NHS_VR_Executive_Briefing.html',
        icon: Activity,
