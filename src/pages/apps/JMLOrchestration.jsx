...
const JMLOrchestration = () => {
    ...
    return (
        <div className="min-h-screen flex font-sans" style={{ background: 'var(--color-bg-primary)', color: 'var(--color-text-primary)' }}>
            <ConsoleWindow
            ...
            <div className="flex-1 flex flex-col h-screen overflow-hidden">
                {/* Header */}
                <header className="h-16 border-b border-gray-200 flex items-center justify-between px-8 shadow-sm z-10" style={{ background: 'var(--color-bg-surface)' }}>
                ...
                {/* View Content */}
                <main className="flex-1 overflow-y-auto p-8" style={{ background: 'var(--color-bg-primary)' }}>
